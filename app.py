...
st.set_page_config(
    ...
    page_icon="📝",
    layout="wide",
    initial_sidebar_state="collapsed", # جعل السايدبار مغلقاً افتراضياً على الموبايل لعدم حجب الشاشة
)

# 🎨 CSS لتنسيق التطبيق متوافق تماماً مع الموبايل والشاشات الكبيرة
st.markdown(
    """
    <style>
    /* محاذاة RTL عامة */
    ...
    /* 📱 تحسينات خاصة بالشاشات الصغيرة والموبايل (Media Queries) */
    @media (max-width: 768px) {
        ...
        /* تصغير الحواف الداخلية لمنطقة المحتوى على الموبايل */
        .block-container {
...
# 5. شريط البحث والتاريخ (استخدام استجابة مرنة للأعمدة)
...
# تقسيم الإحصائيات بشكل مرن ومريح للعين على الموبايل
...
if "البرنامج" in df.columns and not df.empty:
    ...
    pie_chart = (
        ...
        .mark_arc(innerRadius=50, outerRadius=100) # ضبط الحجم ليكون مناسباً لجميع الشاشات
        .encode(
