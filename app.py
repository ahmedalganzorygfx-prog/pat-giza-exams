...
st.set_page_config(
    ...
    page_icon="📝",
    layout="wide",
    initial_sidebar_state="collapsed",  # إغلاق القائمة الجانبية افتراضياً لتوفير مساحة على شاشة الموبايل
)

# 🎨 CSS لتنسيق التطبيق ومحاذاة العناصر مع استجابة كاملة للشاشات الصغيرة والموبايل
st.markdown(
    """
    <style>
    /* محاذاة RTL عامة */
